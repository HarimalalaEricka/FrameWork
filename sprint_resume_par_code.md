...
## Sprint 1 à Sprint 2
- Non explicitement trouvés dans le code actuel (probablement initialisation du framework, mapping de base, etc.)
...
---
Ce résumé est basé sur l'analyse des annotations, classes et commentaires dans les contrôleurs et le coeur du framework.
